 ...
 *
 * Note: resizeImage tests require BINDERY_BIN to be set to the path of the
 * compiled bindery binary. When BINDERY_BIN is not set, resizeImage returns the
 * original image unchanged (fallback behavior).
 */
